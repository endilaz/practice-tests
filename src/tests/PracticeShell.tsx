    ...
    <div className="min-h-screen bg-blue-600">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 space-y-6">
          ...
          {/* Question Text */}
          <div>
            {currentQuestion.question.is_ai_generated && (
              <span
                className="inline-block mb-2 text-[10px] font-semibold uppercase tracking-wider bg-indigo-100 text-indigo-700 border border-indigo-200 rounded px-1.5 py-0.5"
